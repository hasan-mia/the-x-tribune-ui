    ...
    <div className="bg-card border-b border-border sticky top-0 z-40">
      <div className="container mx-auto px-4">
        <div className="flex items-stretch gap-0">
          {/* Breaking Badge */}
          <div className="bg-primary text-primary-foreground py-2 px-4 flex items-center gap-2 whitespace-nowrap">
            <Zap className="w-5 h-5" />
            <span className="font-bold text-sm md:text-base hidden sm:inline">ব্রেকিং নিউজ</span>
          </div>
