...
import OnOverCard from "../content-card/on-over-card"
import VerticalCard from "../content-card/vertical-card"
import VerticalCardWithContent from "../content-card/vertical-card-content"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <VerticalCardWithContent article={newsArticles[0]} />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {newsArticles.slice(1, 5).map((article) => (
                  <OnOverCard key={article.id} article={article} />
                ))}
              </div>
            </div>
          </div>
